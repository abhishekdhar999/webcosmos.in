  ...
  return (
    <div>
      <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 md:w-1/2 lg:w-1/4 bg-secondary rounded-xl">
            <div className="wow fadeInUp group mb-12" data-wow-delay=".1s">
              ...
              <h4 className="mb-3 text-xl font-bold text-heading-white">
              Digital Marketing
              </h4>
              <p className="mb-8 text-dark-6 lg:mb-9">
              Everything from SEO, SMO, SMM, PPC to custom marketing
              </p>
              <a
                href="javascript:void(0)"
                className="text-base font-medium hover:text-primary text-heading-white dark:hover:text-primary"
              >
                Learn More
              </a>
            </div>
          ...
          <div className="w-full px-4 md:w-1/2 lg:w-1/4">
            <div className="wow fadeInUp group mb-12" data-wow-delay=".15s">
              ...
              <p className="mb-8 text-dark-6 lg:mb-9">
              Everything from ORM, Reviews, Press Release to Personal Branding
              </p>
              <a
                href="javascript:void(0)"
                className="text-base font-medium hover:text-primary text-heading-white dark:hover:text-primary"
          ...
          <div className="w-full px-4 md:w-1/2 lg:w-1/4">
            <div className="wow fadeInUp group mb-12" data-wow-delay=".2s">
              ...
              <p className="mb-8 text-dark-6 lg:mb-9">
              Includes everything from Content Writing to Video Creation
              </p>
              <a
                href="javascript:void(0)"
                className="text-base font-medium hover:text-primary text-heading-white dark:hover:text-primary"
