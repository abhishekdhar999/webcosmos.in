        ...
        <div className="flex flex-1 flex-col justify-between bg-secondary p-6">
          <div className="flex-1">
            ...
            <a href="#" className="mt-2 block">
              <p className="text-xl font-semibold text-white">Boost your conversion rate</p>
      ...
      <div className="flex flex-col overflow-hidden rounded-lg shadow-lg">
        ...
        <div className="flex flex-1 flex-col justify-between bg-secondary p-6">
          ...
          <p className="text-sm font-medium text-indigo-600">
            ...
            <a href="#" className="mt-2 block">
              <p className="text-xl font-semibold text-white">How to use search engine optimization to drive sales</p>
      ...
      <div className="flex flex-col overflow-hidden rounded-lg shadow-lg">
        ...
        <div className="flex flex-1 flex-col justify-between bg-secondary p-6">
          ...
          <p className="text-sm font-medium text-indigo-600">
            ...
            <a href="#" className="mt-2 block">
              <p className="text-xl font-semibold text-white">Improve your customer experience</p>
